...
export default class Graph extends React.Component<IGraphProps,
  ...
  public _onButtonOpen1 = ev => {
    let elmnt = document.getElementById('path3028-4');
  ...
  public _onButtonOpen2 = ev => {
    let elmnt = document.getElementById('path3028-0');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }

  public _onButtonOpen3 = ev => {
    let elmnt = document.getElementById('path3028-9');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }

  public _onButtonOpen4 = ev => {
    let elmnt = document.getElementById('path3028-48');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }

  public _onButtonOpen5 = ev => {
    let elmnt = document.getElementById('path3028-8');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }

  public _onButtonOpen6 = ev => {
    let elmnt = document.getElementById('path3028-2');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }

  public _onButtonOpen7 = ev => {
    let elmnt = document.getElementById('path3028-1');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }

  public _onButtonOpen8 = ev => {
    let elmnt = document.getElementById('path3028-7');
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink') });
  }
  ...
  public render() {
    ...
    function Annotation() {
      ...
      console.log(that.state.windowTitle);
      console.log(that.state.windowDescription);
      console.log(that.state.windowLink);
