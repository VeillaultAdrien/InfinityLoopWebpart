...
export default class Graph extends React.Component<IGraphProps,
  { showComponent: Boolean, windowTitle: string, windowDescription: string, windowLink: string, uniqueId: Date, position : string }> {
  ...
  public _onButtonOpen1 = ev => {
    ...
    this.setState({ showComponent: true, windowTitle: elmnt.getAttribute('data-windowTitle'), windowDescription: elmnt.getAttribute('data-windowDescription'), windowLink: elmnt.getAttribute('data-windowLink'), position: elmnt.getAttribute('data-position') });
  }
